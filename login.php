			...
			<div class="card-body">
				<form method="post" action="php/login.php">
					<?php
						if (isset($_GET['error'])) {
							if ($_GET['error'] == 1) {
								...
								$error = 'Debe iniciar sesión para ver el contenido.';
							}?>
					...
					<label class="control-label" for="email">Email</label>
						<input class="form-control" id="email" name="email" type="email" placeholder="Email" value="<?= (isset($_GET['email'])) ? $_GET['email'] : ''; ?>">
					</div>
					<div class="form-group">
