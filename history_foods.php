...
<ul class="nav nav-tabs nav-justified" id="foodsTabs" role="tablist">
	<li class="nav-item">
	...
	<li class="nav-item">
		<a class="nav-link" id="sold-tab" data-toggle="tab" href="#sold" role="tab" aria-controls="sold" aria-selected="false">Vendidos</a>
	</li>
</ul>

<div class="tab-content" id="foodsTabsContent">
